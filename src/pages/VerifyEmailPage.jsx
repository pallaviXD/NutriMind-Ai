      ...
      >
        ...
        {status === "loading" && (
          <>
            <Loader2
              size={48}
              className="animate-spin text-accent-neon mx-auto mb-4"
            />
        ...
        {status === "error" && (
          <>
            ...
            <Link
              to="/login"
              className="block w-full text-center py-3 border border-border rounded-xl text-muted hover:text-foreground hover:border-accent-neon/40 transition-all"
            >
              Back to Sign In
            </Link>
          </>
