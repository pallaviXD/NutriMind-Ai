...
const HEALTH_GOALS = [
  {
    ...
    label: "Gym & Muscle",
    desc: "High protein, caloric surplus, hypertrophy",
    color: "border-blue-500/50 bg-blue-500/10 hover:border-blue-400",
  ...
  },
  {
    ...
    color: "border-orange-500/50 bg-orange-500/10 hover:border-orange-400",
  ...
  },
  {
    ...
    icon: <Pill size={22} />,
    label: "Diabetes Care",
    desc: "Low-GI diet, blood sugar management",
    color: "border-emerald-500/50 bg-emerald-500/10 hover:border-emerald-400",
  ...
  },
  {
    ...
    desc: "Low sodium, heart-healthy DASH diet",
    color: "border-pink-500/50 bg-pink-500/10 hover:border-pink-400",
  ...
  },
  {
    ...
    desc: "Balanced nutrition for everyday health",
    color: "border-purple-500/50 bg-purple-500/10 hover:border-purple-400",
...
const SetupProfile = () => {
  ...
  const bmiLabel = bmi
    ? bmi < 18.5
      ? { t: "Underweight", c: "text-blue-400" }
      : bmi < 25
        ? { t: "Normal", c: "text-green-400" }
        : bmi < 30
          ? { t: "Overweight", c: "text-yellow-400" }
        ...
        <div className="flex items-center justify-center gap-3 mb-6">
          {STEPS.map((s, i) => (
            <React.Fragment key={s}>
              <div
                className={`flex items-center gap-2 ${i <= step ? "opacity-100" : "opacity-30"}`}
              >
                <div
                ...
                <span className="text-xs font-medium hidden sm:block text-muted">
                  {s}
                </span>
              </div>
              {i < STEPS.length - 1 && (
                <div
                  className={`flex-1 h-px max-w-[60px] ${i < step ? "bg-accent-neon" : "bg-border"}`}
                />
              )}
            </React.Fragment>
          ))}
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-muted text-sm mt-1">
                    This helps the AI give you personalized advice.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    max={
                      new Date(Date.now() - 10 * 365.25 * 24 * 3600 * 1000)
                        .toISOString()
                        .split("T")[0]
                    }
                ...
                {bmi && (
                  ...
                  >
                    ...
                    <div className={`text-sm font-semibold ${bmiLabel?.c}`}>
                      {bmiLabel?.t}
                    </div>
                  </motion.div>
                )}
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="active">
                      Active — hard exercise 6-7x/week
                    </option>
            ...
            {step === 1 && (
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-muted text-sm mt-1">
                    NutriMind will tailor everything to match.
                  </p>
                </div>
                <div className="flex flex-col gap-3">
                  {HEALTH_GOALS.map((g) => (
                    ...
                    >
                      ...
                      {data.health_goal === g.key && (
                        <CheckCircle2
                          size={18}
                          className="text-accent-neon shrink-0"
                        />
                      )}
                    </button>
                  ))}
              ...
              {step < STEPS.length - 1 ? (
                ...
                >
                  {loading ? (
                    ...
                    <>
                      <CheckCircle2 size={18} /> Launch Dashboard
                    </>
                  )}
                </button>
              )}
