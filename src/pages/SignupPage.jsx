        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <span className="text-3xl font-bold">
              ...
              <span className="text-muted font-light text-xl">OS</span>
            </span>
          </div>
          <p className="text-muted text-sm">
            Your AI Health Intelligence Platform
          </p>
        </div>
          ...
          {verificationSent ? (
            <div className="text-center py-4">
              ...
              <p className="text-muted text-sm mb-8">
                ...
                <strong className="text-foreground">{form.email}</strong>.<br />
                <br />
                Please click the link to activate your account.
              </p>
              <Link
                to="/login"
                className="w-full inline-block bg-gradient-to-r from-accent-neon to-accent-purple text-white font-bold py-3 rounded-xl hover:shadow-[0_0_25px_rgba(139,92,246,0.4)] transition-all"
              >
                Go to Sign In →
              </Link>
            </div>
            ...
            <>
              ...
              <p className="text-center text-sm text-muted mt-6">
                ...
                <Link
                  to="/login"
                  className="text-accent-neon hover:text-accent-cyan font-semibold transition-colors"
                >
                  Sign in
                </Link>
              </p>
