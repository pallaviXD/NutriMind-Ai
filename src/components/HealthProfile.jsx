...
const PROFILES = [
  ...
  },
  {
    ...
    targets: { calories: 2200, protein: 150, carbs: 250, fat: 80 },
  },
];
    ...
    <div className="h-full overflow-y-auto p-6 flex flex-col gap-6">
      <div className="shrink-0">
        ...
        <p className="text-muted text-sm mt-1">
          Complete your health details for personalized AI recommendations.
        </p>
      </div>
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2">
                <label className="text-xs text-muted uppercase tracking-wider font-semibold block mb-2">
                  Date of Birth{" "}
                  {age && (
                    <span className="text-accent-neon normal-case">
                      ({age} years old)
                    </span>
                  )}
                </label>
              ...
              <div>
                <label className="text-xs text-muted uppercase tracking-wider font-semibold block mb-2">
                  Hip (cm){" "}
                  <span className="text-muted/60 normal-case text-[10px]">
                    optional
                  </span>
                </label>
                <input
                  type="number"
                  value={details.hip_cm}
          ...
          <div className="glass-panel p-5">
            <h2 className="font-bold text-base mb-3 flex items-center gap-2">
              <ShieldAlert size={16} className="text-yellow-400" /> Health
              Conditions
            </h2>
          ...
          >
            {savingDetails ? (
              ...
              <>
                <Save size={16} /> Save Body Details
              </>
            )}
          </button>
        </div>
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-muted">
                      {p.targets.calories} kcal · {p.targets.protein}g P ·{" "}
                      {p.targets.carbs}g C
                    </div>
                  </div>
                  {selected === p.key && (
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              >
                {loadingAdvice ? (
                  ...
                  <>
                    <Sparkles size={12} /> Get AI Advice
                  </>
                )}
              </button>
            </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {aiAdvice.eat?.map((f, i) => (
                        <span
                          key={i}
                          className="px-3 py-1.5 bg-green-500/10 border border-green-500/30 text-green-300 rounded-full text-xs font-medium"
                        >
                          {f}
                        </span>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {aiAdvice.avoid?.map((f, i) => (
                        <span
                          key={i}
                          className="px-3 py-1.5 bg-red-500/10 border border-red-500/30 text-red-300 rounded-full text-xs font-medium"
                        >
                          {f}
                        </span>
                      ))}
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {aiAdvice.tips?.map((t, i) => (
                        ...
                        >
                          <span className="text-accent-neon mt-0.5 shrink-0">
                            →
                          </span>{" "}
                          {t}
                        </li>
              ...
              {!aiAdvice && !loadingAdvice && (
                ...
                >
                  ...
                  <p className="text-muted text-sm">
                    ...
                    to get personalized food recommendations based on your
                    health profile
                  </p>
                </motion.div>
              )}
